...
//  }
  ...
  if( !(id == APDS9960_ID_1 || id == APDS9960_ID_2) ) {
      LOG_INFO("id = %d\n\r", id);
      LOG_INFO("APDS9960_ID_1\n\r");
      return false;
  }

  /* Set ENABLE register to 0 (disable all features) */
  if( !setMode(ALL, OFF) ) {
      LOG_INFO("setMode failed\n\r");
      return false;
  }
...
//  }
  ...
  if( !setGestureEnterThresh(DEFAULT_GPENTH) ) {
      LOG_INFO("setGestureEnterThresh failed\n\r");
      return false;
  }
  if( !setGestureExitThresh(DEFAULT_GEXTH) ) {
      LOG_INFO("setGestureExitThresh failed\n\r");
      return false;
  }
  if( !wireWriteDataByte(APDS9960_GCONF1, DEFAULT_GCONF1) ) {
      LOG_INFO("wireWriteDataByte failed\n\r");
      return false;
  }
  if( !setGestureGain(DEFAULT_GGAIN) ) {
      LOG_INFO("setGestureGain failed\n\r");
      return false;
  }
  if( !setGestureLEDDrive(DEFAULT_GLDRIVE) ) {
      LOG_INFO("setGestureLEDDrive failed\n\r");
      return false;
  }
  if( !setGestureWaitTime(DEFAULT_GWTIME) ) {
      LOG_INFO("setGestureWaitTime failed\n\r");
      return false;
  }
  ...
  if( !setGestureIntEnable(DEFAULT_GIEN) ) {
      LOG_INFO("setGestureIntEnable failed\n\r");
      return false;
  }
